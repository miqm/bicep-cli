...
with open(".github/workflows/dependabot_hack.yml", "r") as dependencyStream:
    ...
    for step in steps:
        ...
        match dependency[0]:
            case "azure/bicep":
                dockerArgs["BICEP_VERSION"] = dependency[1][1:]
            case "azure/azure-cli":
                dockerArgs["CLI_VERSION"] = dependency[1][10:]
            case "mikefarah/yq":
                dockerArgs["YQ_VERSION"] = dependency[1][1:]
            case "geofffranks/spruce":
                dockerArgs["SPRUCE_VERSION"] = dependency[1][1:]
            ...
            case "tfutils/tfenv":
                dockerArgs["TFENV_VERSION"] = dependency[1][1:]
            case "kubernetes/kubernetes":
                dockerArgs["KUBECTL_VERSION"] = dependency[1][1:]
            case "Azure/kubelogin":
